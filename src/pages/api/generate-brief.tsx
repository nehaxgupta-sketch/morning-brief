...
// Modularization stage 8: storylines logic extracted.
import type {
  StorylineRow,
} from '@/lib/generate-brief/storylines';
import {
  STORYLINE_MAX_ACTIVE,
  STORYLINE_MAX_NEW_PER_DAY,
  STORYLINE_FALLBACK_CAP,
  STORYLINE_FALLBACK_CONCURRENCY,
  STORYLINE_DORMANT_AFTER_DAYS,
  STORYLINE_CONCLUDE_AFTER_DAYS,
  flattenDailyContent,
  slugifyTitle,
  callSearchModelJson,
  storylineTagAndDetect,
  insertStorylineEvent,
  buildBackfillPrompt,
  fallbackFetchStoryline,
  regenStorySoFar,
} from '@/lib/generate-brief/storylines';
...
// ============================================================================
// SECTION 27 storyline LOGIC -> @/lib/generate-brief/storylines.
// modeStorylines stays below and calls it.
// ============================================================================
